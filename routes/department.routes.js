...
const departmentsData = [
  ...
  },
  {
    ...
    description: 'Department dealing with the prevention, diagnosis, and treatment of adult diseases',
    doctors: [],
  },
  {
    name: 'Surgery',
  ...
  },
  {
    ...
    description: 'Department specializing in urinary tract and male reproductive system issues',
    doctors: [],
  },
  {
    name: 'Nephrology',
...
router.get("/create", (req, res, next) => {
  ...
  .then((departments) => {
    console.log('Departments created and saved to the database:', departments);
...
Department.create(deptData.name)
.then(addedDept=>{
  res.json(addedDept)
})
.catch(error=>{
